                        ...
                        <Popover
                            ...
                            content={
                                <div style={{maxWidth: 280}}>
                                    <p style={{marginBottom: 8}}>Risk your wager for a 2x payout</p>
                                    <ul style={{paddingLeft: 18, marginBottom: 0}}>
                                        <li>You alone are correct → double your wager</li>
                                        <li>You and one other → whatever you wagered</li>
                                        <li>You and 2+ others → you get nothing</li>
                                        <li>Get it wrong → negative wager</li>
                                    </ul>
                                </div>
                            }>
